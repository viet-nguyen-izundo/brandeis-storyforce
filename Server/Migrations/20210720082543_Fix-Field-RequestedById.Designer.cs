...
namespace StoryForce.Server.Migrations
{
    ...
    [Migration("20210720082543_Fix-Field-RequestedById")]
    partial class FixFieldRequestedById
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PersonStoryFile1", b =>
                {
                    b.Property<int>("FavouritesPeopleId")
                        .HasColumnType("integer");

                    b.Property<int>("FavouritesStoryFileId")
                        .HasColumnType("integer");

                    b.HasKey("FavouritesPeopleId", "FavouritesStoryFileId");
            ...
            modelBuilder.Entity("StoryForce.Shared.Models.StoryFile", b =>
                {
                    ...
                    b.Property<string>("StoryHistoryLog")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("PersonStoryFile1", b =>
                {
                    b.HasOne("StoryForce.Shared.Models.Person", null)
                        .WithMany()
                        .HasForeignKey("FavouritesPeopleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StoryForce.Shared.Models.StoryFile", null)
                        .WithMany()
                        .HasForeignKey("FavouritesStoryFileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
