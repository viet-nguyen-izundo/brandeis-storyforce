...
{
    public class SendMailService : IEmailSender, IHostedService, IDisposable
    {
        ...
        public SendMailService(IConfiguration configuration, IOptionsMonitor<SmtpOptions> optionsMonitor, ILogger<SendMailService> logger)
        {
        ...
        public async Task SendEmailAsync(string email, string subject, string htmlMessage)
        {
            ...
            message.From.Add(MailboxAddress.Parse("viet.nguyen@izundo.com"));
